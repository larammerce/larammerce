...
<div class="btn-group dropup fab green">
    @if(count($buttons) > 1)
        <button act="link" type="button" class=" dropdown-toggle" data-toggle="dropdown" aria-haspopup="true"
                aria-expanded="false">
        ...
        <ul class="dropdown-menu">
            @if(in_array('create', $buttons))
                <li>
                    <button act="link" class="dropdown-item"
                            href="{{route('admin.'.$dashed_string.'.create')}}{{(isset($url_parameters) and isset($url_parameters["create"])) ? $url_parameters["create"] : ""}}">
            ...
            @if(in_array('download', $buttons))
                <li>
                    <button act="link" class="dropdown-item" href="" data-toggle="modal"
                            data-target="#excel-export-modal">
