    ...
    <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 grid-item roless">
        <div class="item-container">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 col">
                ...
                <div>{{$gallery->identifier}}</div>
            </div>
            <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12 col col-action">
                <div class="label">عملیات</div>
                <div class="actions-container">
                    <div class="col-lg-12 col-md-12 col-xs-12">
                        <a class="btn btn-sm btn-primary" href="{{route('admin.gallery.edit', $gallery)}}">
                        ...
                        <a class="btn btn-sm btn-success" href="{{route('admin.gallery.show', $gallery)}}">
                            <i class="fa fa-eye"></i>
                        </a>
                    </div>
                </div>
