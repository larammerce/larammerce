    ...
    <span class="material-switch pull-right">آیا امکان اعمال تخفیف روی این محصول وجود دارد ؟ &nbsp
        ...
        @if(should_use_per_product_tax_config())
            <div class="input-group group-sm col-lg-12 col-sm-12 col-md-12 col-xs-12"
                ...
                <input class="form-control input-sm number-control" name="tax_percentage"
                       value="{{ $product->tax_percentage }}">
            </div>
            <div class="input-group group-sm col-lg-12 col-sm-12 col-md-12 col-xs-12"
                @roleinput($product, "toll_percentage")>
                <span class="label">درصد عوارض</span>
                <input class="form-control input-sm number-control" name="toll_percentage"
                       value="{{ $product->toll_percentage }}">
            </div>
            <div class="input-group group-sm col-lg-12 col-sm-12 col-md-12 col-xs-12"
            ...
            <div class="input-group group-sm col-lg-12 col-sm-12 col-md-12 col-xs-12"
                ...
                <span class="material-switch pull-right">آیا تنظیمات مالیاتی پیشفرض لحاظ شود؟ &nbsp
