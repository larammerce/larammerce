...
@section('bread_crumb')
    ...
    <li class="active"><a href="{{route('admin.invoice.edit', $invoice)}}">تغییر وضعیت سفارش به در حال ارسال</a></li>
...
@section('form_body')
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="input-group group-sm col-lg-12 col-sm-12 col-md-12 col-xs-12">
            ...
            <input class="form-control input-sm" name="shipment_data_delivery_date">
        </div>
        <span class="tip">مثلا: 17-9-1397 ساعت 15 الی 17</span>
        <div class="input-group group-sm col-lg-12 col-sm-12 col-md-12 col-xs-12">
