...
@section('form_title')تغییر وضعیت سفارش به مجوز خروج از انبار@endsection

@section('form_attributes') action="{{route('admin.invoice.set-shipment-exit-tab', $invoice)}}" method="POST" @endsection
