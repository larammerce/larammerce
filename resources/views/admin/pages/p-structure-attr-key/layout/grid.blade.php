                ...
                <div class="actions-container">
                    ...
                    <div class="col-lg-7 col-md-6 col-xs-6">
                        <span class="material-switch">کاربر ارشد
                            <input id="has_value_{{$attribute_key->id}}" name="has_value_{{$attribute_key->id}}"
                                   type="checkbox" @if($attribute_key->has_value) checked @endif disabled/>
                            <label for="has_value_{{$attribute_key->id}}"></label>
                        </span>
                    </div>
                </div>
            </div>
