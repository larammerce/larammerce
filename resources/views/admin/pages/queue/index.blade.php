            ...
            @foreach($queues as $queue => $data)
                <div class="panel panel-default">
                    <div class="input-group group-sm col-lg-12 col-sm-12 col-md-12 col-xs-12">
                        <div class="container">
                            <form class="pb-10" id="{{'toggle-queue-status-'.$queue}}" method="POST" action="{{route('admin.setting.queue.update')}}">
                                @csrf
                                ...
                                <input type="submit" @if($data['status'] == \App\Enums\Queue\QueueStatus::RUNNING) class="mr-10 btn btn-warning"
