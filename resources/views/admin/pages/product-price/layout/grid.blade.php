            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 col col-action">
                ...
                <div class="actions-container">
                    <div class="col-lg-5 col-md-12 col-xs-12">
                        <a class="btn btn-sm btn-primary" href="{{route('admin.product-price.edit', $product_price)}}">
                        ...
                        <a class="btn btn-sm btn-success" href="{{route('admin.product-price.show', $product_price)}}">
                            <i class="fa fa-eye"></i>
                        </a>
                    </div>
                </div>
