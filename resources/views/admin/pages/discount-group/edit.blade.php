...
@section('bread_crumb')
    ...
    <li class="active"><a href="{{route('admin.discount-group.create')}}">ویرایش کردن پلن تخفیف</a></li>
@endsection

@section('form_title')اضافه کردن پلن تخفیف@endsection

@section('form_attributes') action="{{route('admin.discount-group.update', $discount_group)}}" method="POST" form-with-hidden-checkboxes @endsection

@section('form_body')
    {{ method_field('PUT') }}
    <script>window.PAGE_ID = "admin.pages.discount-group.edit";</script>
