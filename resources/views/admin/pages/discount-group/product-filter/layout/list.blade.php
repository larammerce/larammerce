        ...
        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6 col">
            ...
            <div class="actions-container">
                ...
                <a class="btn btn-sm btn-info virt-form"
                   data-action="{{ route('admin.discount-group.product-filter.attach', compact("discount_group")) }}"
                   data-method="POST" data-fields='{"product_filter_id": "{{$product_filter->id}}"}'>
                    <i class="fa fa-refresh"></i>
                </a>
                <a class="btn btn-sm btn-danger virt-form"
                   data-action="{{ route('admin.discount-group.product-filter.detach', compact("discount_group", "product_filter")) }}"
