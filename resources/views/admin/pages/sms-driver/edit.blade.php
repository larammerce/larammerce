...
@section('bread_crumb')
    ...
    <li class="active"><a href="{{route('admin.setting.sms-driver.edit')}}">ویرایش تنظیمات سیستم ارسال پیامک</a></li>
@endsection

@section('form_title')ویرایش تنظیمات سیستم ارسال پیامک@endsection

@section('form_attributes') action="{{route('admin.setting.sms-driver.update')}}" method="POST" enctype="multipart/form-data" form-with-hidden-checkboxes @endsection

@section('form_body')
    <script>window.PAGE_ID = "admin.pages.sms-driver.edit";</script>
    {{ method_field('PUT') }}
                            ...
                            <div class="input-group group-sm col-lg-12 col-sm-12 col-md-12 col-xs-12">
                                @if($input_data["type"] == "checkbox")
                                    <span class="material-switch pull-right">
                                        @lang('sms.config.'.$input_name) ؟ &nbsp
                                ...
                                @else
                                    <span class="label">@lang('sms.config.'.$input_name)</span>
