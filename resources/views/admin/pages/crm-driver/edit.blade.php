...
@section('bread_crumb')
    ...
    <li class="active"><a href="{{route('admin.setting.crm-driver.edit')}}">ویرایش تنظیمات سیستم اتصال سی آر ام</a></li>
@endsection

@section('form_title')ویرایش تنظیمات سیستم اتصال سی آر ام@endsection

@section('form_attributes') action="{{route('admin.setting.crm-driver.update')}}" method="POST" enctype="multipart/form-data" form-with-hidden-checkboxes @endsection

@section('form_body')
    <script>window.PAGE_ID = "admin.pages.crm-driver.edit";</script>
    {{ method_field('PUT') }}
                            ...
                            <div class="input-group group-sm col-lg-12 col-sm-12 col-md-12 col-xs-12">
                                @if($input_data["type"] == "checkbox")
                                    <span class="material-switch pull-right">
                                        @lang('crm.config.'.$input_name) ؟ &nbsp
                                ...
                                @else
                                    <span class="label">@lang('crm.config.'.$input_name)</span>
