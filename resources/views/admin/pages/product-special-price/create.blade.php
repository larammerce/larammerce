...
@section('bread_crumb')
    ...
    <li class="active"><a href="{{route('admin.product-special-price.create')}}">اضافه کردن قیمت ویژه جدید</a></li>

@endsection

@section('form_title')اضافه کردن قیمت ویژه@endsection

@section('form_attributes') action="{{route('admin.product-special-price.store')}}" method="POST" @endsection
...
@section('form_body')
    ...
    <div class="input-group with-unit group-sm col-lg-12 col-sm-12 col-md-12 col-xs-12">
        <span class="label">قیمت ویژه جدید</span>
