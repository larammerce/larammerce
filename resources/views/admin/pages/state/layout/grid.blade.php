@foreach($states as $state)
    <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 grid-item roless">
        <div class="item-container">
            ...
            <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12 col col-action">
                <div class="label">عملیات</div>
                <div class="actions-container">
                    <div class="col-lg-12 col-md-12 col-xs-12">
                        <a class="btn btn-sm btn-primary" href="{{route('admin.state.edit', $state)}}">
                            <i class="fa fa-pencil"></i>
                        </a>
                        <a class="btn btn-sm btn-danger virt-form"
                           data-action="{{ route('admin.state.destroy', $state) }}"
                           data-method="DELETE" confirm>
                            <i class="fa fa-trash"></i>
                        </a>
                        <a class="btn btn-sm btn-success" href="{{route('admin.state.show', $state)}}">
                            <i class="fa fa-eye"></i>
                        </a>
                    </div>
                </div>
