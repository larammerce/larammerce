...
/**
 * @method static ExcelCacheSettingData getRecord(string $name = "", ?string $parent_id = null)
 */
class ExcelCacheConfig extends BaseFeatureConfig
{
    ...
    public static function defaultRecord($name): ExcelCacheSettingData
    {
        return new ExcelCacheSettingData();
    }
    ...
    public static function update(string $model, array $model_attributes = [], array $model_relations = []): bool
    {
        ...
        try {
            ...
            Log::error("ExcelCacheConfig.update.NotValidSettingRecordException." . $e->getMessage());
            return false;
        }
    }
}
