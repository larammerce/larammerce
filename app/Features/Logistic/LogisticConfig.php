...
namespace App\Features\Logistic;
...
/**
 * @method static LogisticSettingData getRecord(string $name = "", ?string $parent_id = null)
 */
class LogisticConfig extends BaseFeatureConfig
{
    ...
    public static function defaultRecord($name): LogisticSettingData
    {
        return new LogisticSettingData();
    }
                                  ...
                                  $rows_offset = null, $rows_available = null): void
    {
        try {
            ...
            Log::error("LogisticConfig.update.failed." . $e->getMessage());
        }
    }
