...
namespace App\Utils\Translation\Validation;

use App\Utils\Translation\Locales;
...
class RuleFactory
{
    ...
    {
        $this->format = $format ?? $config->get('translation.rule_factory.format');
        $this->prefix = $prefix ?? $config->get('translation.rule_factory.prefix');
        $this->suffix = $suffix ?? $config->get('translation.rule_factory.suffix');
    }
