...
use App\Libraries\Excel\Concerns\WithBackgroundColor;
use App\Libraries\Excel\Concerns\WithCustomValueBinder;
use App\Libraries\Excel\Concerns\WithDefaultStyles;
use App\Libraries\Excel\Concerns\WithEvents;
use App\Libraries\Excel\Concerns\WithMultipleSheets;
use App\Libraries\Excel\Concerns\WithProperties;
...
use App\Libraries\Excel\Factories\WriterFactory;
use App\Libraries\Excel\Files\RemoteTemporaryFile;
...
class Writer
{
    ...
    /**
     * @param  \App\Libraries\Excel\Files\TemporaryFileFactory  $temporaryFileFactory
     */
