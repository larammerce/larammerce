...
use App\Libraries\Excel\Concerns\WithCustomQuerySize;
...
use App\Libraries\Excel\Jobs\AppendDataToSheet;
use App\Libraries\Excel\Jobs\AppendQueryToSheet;
use App\Libraries\Excel\Jobs\AppendViewToSheet;
use App\Libraries\Excel\Jobs\CloseSheet;
use App\Libraries\Excel\Jobs\QueueExport;
use App\Libraries\Excel\Jobs\StoreQueuedExport;
...
class QueuedWriter
{
    ...
    /**
     * @param  \App\Libraries\Excel\Concerns\FromQuery  $export
    ...
    /**
     * @param  \App\Libraries\Excel\Concerns\FromView  $export
     * @param  \App\Libraries\Excel\Files\TemporaryFile  $temporaryFile
     * @param  string  $writerType
     * @param  int  $sheetIndex
     * @return Collection
    ...
    /**
     * @param  object|\App\Libraries\Excel\Concerns\WithCustomChunkSize  $export
     * @return int
     */
