...
use App\Utils\PushNotification\AbstractPayload;
use App\Utils\PushNotification\App;
...
class PushNotificationBridge
{
	 ...
	 */
	private $services = [
			\App\Libraries\PushNotification\Services\GCM\GCMService::class,
			\App\Libraries\PushNotification\Services\APNS\ApnService::class,
	];
	...
	protected function hasTokenTrait($tk)
	{
		foreach( class_uses( $tk ) as $t ) {
			if( $t === 'App\Libraries\PushNotification\TokenTrait'){
				return true;
			}
		}
