...
class ProductImportFromJsonFile extends Job implements ShouldQueue {
    ...
    public function calculatePrice($base_price, $keywords): float|int {
        ...
        if (str_contains($keywords, "boot") or
            ...
            $result = intval($base_price * 0.90 * 1.75 * $this->price_ratio) + 850000;
            ...
            $result = intval($base_price * 0.85 * 1.75 * $this->price_ratio) + 270000;
        } else {
            $result = intval($base_price * 0.90 * 1.75 * $this->price_ratio) + 300000;
        }
