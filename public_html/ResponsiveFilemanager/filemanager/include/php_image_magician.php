...
*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-**-*-*-*-*-*-*-*-*-*-*-*-*-*/
        ...
        #
    {
        ...
        if ($autoRotate) {
            ...
            if (count(is_countable($exifData) ? $exifData : []) > 0) {
...
*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-**-*-*-*-*-*-*-*-*-*-*-*-*-*/
        ...
        #
    {
        ...
        if (count(is_countable($this->captionBoxPositionArray) ?
                $this->captionBoxPositionArray : []) == 4) {
...
*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-**-*-*-*-*-*-*-*-*-*-*-*-*-*/
        ...
        #
    {
        ...
        if (count(is_countable($apPeicesArray) ? $apPeicesArray : []) == 2) {
        ...
        if (count(is_countable($flPeicesArray) ? $flPeicesArray : []) == 2) {
        ...
        if (count(is_countable($fnPeicesArray) ? $fnPeicesArray : []) == 2) {
...
## --------------------------------------------------------
    ...
    private function GetPixelColor(&$img, $x, $y)
        ...
        #
    {
        if (!is_resource($img) and !($this->imageResized instanceof \GdImage)) {
            return false;
        }
