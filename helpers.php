...
use App\Libraries\PlatformDetector\DetectService;
use App\Libraries\PlatformDetector\OSType;
...
if (!function_exists('get_system_messages')) {
    function get_system_messages() {
        try {
            $messages = SystemMessageHelper::getMessages();
            SystemMessageHelper::flushMessages();
            return $messages;
        } catch (Exception $e) {
            return [];
        }
...
if (!function_exists('has_system_messages')) {
    function has_system_messages(): bool {
        return SystemMessageHelper::hasMessages();
    }
}
...
if (!function_exists("day_of_week")) {
    function day_of_week(int $diff) {
        return \App\Libraries\Jalali\JDate::forge(\Illuminate\Support\Carbon::now()->addDay($diff))->format("%A");
    }
}

if (!function_exists("get_current_formal_date")) {
    function get_current_formal_date() {
        return \App\Helpers\TimeHelper::getCurrentFormalDate();
    }
}

if (!function_exists("get_current_date")) {
    function get_current_date() {
        return \App\Helpers\TimeHelper::getCurrentDate();
    }
}
...
if (!function_exists("history_back")) {
    function history_back(): ?string {
        return \App\Helpers\HistoryHelper::back();
    }
}
